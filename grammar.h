...
RuleRightSideElement _rhs59[] = {&_lowPrecedenceOperator, &_term, &_moreTerms, };
struct rule _rule59 = {.lhs = NT_MORETERMS, .rhs = _rhs59, .isEpsilon = false, .rhsLength = 3};
struct rule _rule60 = {.lhs = NT_MORETERMS, .isEpsilon = true};
...
RuleRightSideElement _rhs61[] = {&_factor, &_moreFactors, };
struct rule _rule61 = {.lhs = NT_TERM, .rhs = _rhs61, .isEpsilon = false, .rhsLength = 2};
struct ruleRightSideElement _highPrecedenceOperator = {false, .symbol.nonTerminal = NT_HIGHPRECEDENCEOPERATOR};
RuleRightSideElement _rhs62[] = {&_highPrecedenceOperator, &_factor, &_moreFactors, };
struct rule _rule62 = {.lhs = NT_MOREFACTORS, .rhs = _rhs62, .isEpsilon = false, .rhsLength = 3};
struct rule _rule63 = {.lhs = NT_MOREFACTORS, .isEpsilon = true};
RuleRightSideElement _rhs64[] = {&_tk_op, &_arithmeticExpression, &_tk_cl, };
struct rule _rule64 = {.lhs = NT_FACTOR, .rhs = _rhs64, .isEpsilon = false, .rhsLength = 3};
RuleRightSideElement _rhs65[] = {&_var, };
struct rule _rule65 = {.lhs = NT_FACTOR, .rhs = _rhs65, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _tk_mul = {true, .symbol.terminal = TK_MUL};
RuleRightSideElement _rhs66[] = {&_tk_mul, };
struct rule _rule66 = {.lhs = NT_HIGHPRECEDENCEOPERATOR, .rhs = _rhs66, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _tk_div = {true, .symbol.terminal = TK_DIV};
RuleRightSideElement _rhs67[] = {&_tk_div, };
struct rule _rule67 = {.lhs = NT_HIGHPRECEDENCEOPERATOR, .rhs = _rhs67, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _tk_plus = {true, .symbol.terminal = TK_PLUS};
RuleRightSideElement _rhs68[] = {&_tk_plus, };
struct rule _rule68 = {.lhs = NT_LOWPRECEDENCEOPERATOR, .rhs = _rhs68, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _tk_minus = {true, .symbol.terminal = TK_MINUS};
RuleRightSideElement _rhs69[] = {&_tk_minus, };
struct rule _rule69 = {.lhs = NT_LOWPRECEDENCEOPERATOR, .rhs = _rhs69, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _logicalOp = {false, .symbol.nonTerminal = NT_LOGICALOP};
RuleRightSideElement _rhs70[] = {&_tk_op, &_booleanExpression, &_tk_cl, &_logicalOp, &_tk_op, &_booleanExpression, &_tk_cl, };
struct rule _rule70 = {.lhs = NT_BOOLEANEXPRESSION, .rhs = _rhs70, .isEpsilon = false, .rhsLength = 7};
struct ruleRightSideElement _relationalOp = {false, .symbol.nonTerminal = NT_RELATIONALOP};
RuleRightSideElement _rhs71[] = {&_var, &_relationalOp, &_var, };
struct rule _rule71 = {.lhs = NT_BOOLEANEXPRESSION, .rhs = _rhs71, .isEpsilon = false, .rhsLength = 3};
struct ruleRightSideElement _tk_not = {true, .symbol.terminal = TK_NOT};
RuleRightSideElement _rhs72[] = {&_tk_not, &_tk_op, &_booleanExpression, &_tk_cl, };
struct rule _rule72 = {.lhs = NT_BOOLEANEXPRESSION, .rhs = _rhs72, .isEpsilon = false, .rhsLength = 4};
struct ruleRightSideElement _tk_num = {true, .symbol.terminal = TK_NUM};
RuleRightSideElement _rhs73[] = {&_tk_num, };
struct rule _rule73 = {.lhs = NT_VAR, .rhs = _rhs73, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _tk_rnum = {true, .symbol.terminal = TK_RNUM};
RuleRightSideElement _rhs74[] = {&_tk_rnum, };
struct rule _rule74 = {.lhs = NT_VAR, .rhs = _rhs74, .isEpsilon = false, .rhsLength = 1};
RuleRightSideElement _rhs75[] = {&_singleOrRecId, };
...
RuleRightSideElement _rhs76[] = {&_tk_and, };
struct rule _rule76 = {.lhs = NT_LOGICALOP, .rhs = _rhs76, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _tk_or = {true, .symbol.terminal = TK_OR};
RuleRightSideElement _rhs77[] = {&_tk_or, };
struct rule _rule77 = {.lhs = NT_LOGICALOP, .rhs = _rhs77, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _tk_lt = {true, .symbol.terminal = TK_LT};
RuleRightSideElement _rhs78[] = {&_tk_lt, };
struct rule _rule78 = {.lhs = NT_RELATIONALOP, .rhs = _rhs78, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _tk_le = {true, .symbol.terminal = TK_LE};
RuleRightSideElement _rhs79[] = {&_tk_le, };
struct rule _rule79 = {.lhs = NT_RELATIONALOP, .rhs = _rhs79, .isEpsilon = false, .rhsLength = 1};
struct ruleRightSideElement _tk_eq = {true, .symbol.terminal = TK_EQ};
RuleRightSideElement _rhs80[] = {&_tk_eq, };
...
RuleRightSideElement _rhs81[] = {&_tk_gt, };
...
RuleRightSideElement _rhs82[] = {&_tk_ge, };
...
RuleRightSideElement _rhs83[] = {&_tk_ne, };
...
RuleRightSideElement _rhs84[] = {&_tk_return, &_optionalReturn, &_tk_sem, };
struct rule _rule84 = {.lhs = NT_RETURNSTMT, .rhs = _rhs84, .isEpsilon = false, .rhsLength = 3};
RuleRightSideElement _rhs85[] = {&_tk_sql, &_idList, &_tk_sqr, };
struct rule _rule85 = {.lhs = NT_OPTIONALRETURN, .rhs = _rhs85, .isEpsilon = false, .rhsLength = 3};
struct rule _rule86 = {.lhs = NT_OPTIONALRETURN, .isEpsilon = true};
struct ruleRightSideElement _moreIds = {false, .symbol.nonTerminal = NT_MOREIDS};
RuleRightSideElement _rhs87[] = {&_tk_id, &_moreIds, };
struct rule _rule87 = {.lhs = NT_IDLIST, .rhs = _rhs87, .isEpsilon = false, .rhsLength = 2};
RuleRightSideElement _rhs88[] = {&_tk_comma, &_idList, };
struct rule _rule88 = {.lhs = NT_MOREIDS, .rhs = _rhs88, .isEpsilon = false, .rhsLength = 2};
struct rule _rule89 = {.lhs = NT_MOREIDS, .isEpsilon = true};
