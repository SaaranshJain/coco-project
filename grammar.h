...
Grammar getLanguageGrammar(){
	...
	*otherFunctions = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_OtherFunctions}};
	RuleRightSideElement mainFunction = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*mainFunction = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_MainFunction}};
	...
	*rule1 = (struct rule) {.lhs = NT_MainFunction, .rhsLength = 3, .rhs = rhs1};
	RuleRightSideElement function = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*function = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_Function}};
	...
	*rule2 = (struct rule) {.lhs = NT_OtherFunctions, .rhsLength = 2, .rhs = rhs2};
	RuleRightSideElement eps = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*eps = (struct ruleRightSideElement) {true, true, {.terminal = TK_ID }};
	...
	*rule5 = (struct rule) {.lhs = NT_InputPar, .rhsLength = 6, .rhs = rhs5};
	...
	*rule6 = (struct rule) {.lhs = NT_OutputPar, .rhsLength = 6, .rhs = rhs6};
	...
	*rule8 = (struct rule) {.lhs = NT_ParameterList, .rhsLength = 3, .rhs = rhs8};
	RuleRightSideElement primitiveDatatype = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*primitiveDatatype = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_PrimitiveDatatype}};
	...
	*rule9 = (struct rule) {.lhs = NT_DataType, .rhsLength = 1, .rhs = rhs9};
	RuleRightSideElement constructedDatatype = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*constructedDatatype = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_ConstructedDatatype}};
	...
	*rule10 = (struct rule) {.lhs = NT_DataType, .rhsLength = 1, .rhs = rhs10};
	RuleRightSideElement tk_int = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_int = (struct ruleRightSideElement) {false, true, {.terminal = TK_INT }};
	...
	*rule11 = (struct rule) {.lhs = NT_PrimitiveDatatype, .rhsLength = 1, .rhs = rhs11};
	RuleRightSideElement tk_real = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_real = (struct ruleRightSideElement) {false, true, {.terminal = TK_REAL }};
	...
	*rule12 = (struct rule) {.lhs = NT_PrimitiveDatatype, .rhsLength = 1, .rhs = rhs12};
	RuleRightSideElement tk_record = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_record = (struct ruleRightSideElement) {false, true, {.terminal = TK_RECORD }};
	RuleRightSideElement tk_ruid = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_ruid = (struct ruleRightSideElement) {false, true, {.terminal = TK_RUID }};
	...
	*rule13 = (struct rule) {.lhs = NT_ConstructedDatatype, .rhsLength = 2, .rhs = rhs13};
	RuleRightSideElement tk_union = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_union = (struct ruleRightSideElement) {false, true, {.terminal = TK_UNION }};
	...
	*rule14 = (struct rule) {.lhs = NT_ConstructedDatatype, .rhsLength = 2, .rhs = rhs14};
	...
	*rule15 = (struct rule) {.lhs = NT_ConstructedDatatype, .rhsLength = 1, .rhs = rhs15};
	RuleRightSideElement tk_comma = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_comma = (struct ruleRightSideElement) {false, true, {.terminal = TK_COMMA }};
	...
	*rule16 = (struct rule) {.lhs = NT_RemainingList, .rhsLength = 2, .rhs = rhs16};
	...
	*rule18 = (struct rule) {.lhs = NT_Stmts, .rhsLength = 4, .rhs = rhs18};
	RuleRightSideElement actualOrRedefined = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*actualOrRedefined = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_ActualOrRedefined}};
	...
	*rule19 = (struct rule) {.lhs = NT_TypeDefinitions, .rhsLength = 2, .rhs = rhs19};
	...
	*rule20 = (struct rule) {.lhs = NT_TypeDefinitions, .rhsLength = 1, .rhs = rhs20};
	RuleRightSideElement typeDefinition = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*typeDefinition = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_TypeDefinition}};
	...
	*rule21 = (struct rule) {.lhs = NT_ActualOrRedefined, .rhsLength = 1, .rhs = rhs21};
	RuleRightSideElement definetypeStmt = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*definetypeStmt = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_DefinetypeStmt}};
	...
	*rule22 = (struct rule) {.lhs = NT_ActualOrRedefined, .rhsLength = 1, .rhs = rhs22};
	RuleRightSideElement fieldDefinitions = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*fieldDefinitions = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_FieldDefinitions}};
	RuleRightSideElement tk_endrecord = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_endrecord = (struct ruleRightSideElement) {false, true, {.terminal = TK_ENDRECORD }};
	...
	*rule23 = (struct rule) {.lhs = NT_TypeDefinition, .rhsLength = 4, .rhs = rhs23};
	RuleRightSideElement tk_endunion = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_endunion = (struct ruleRightSideElement) {false, true, {.terminal = TK_ENDUNION }};
	...
	*rule24 = (struct rule) {.lhs = NT_TypeDefinition, .rhsLength = 4, .rhs = rhs24};
	RuleRightSideElement fieldDefinition = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*fieldDefinition = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_FieldDefinition}};
	RuleRightSideElement moreFields = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*moreFields = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_MoreFields}};
	...
	*rule26 = (struct rule) {.lhs = NT_FieldDefinition, .rhsLength = 5, .rhs = rhs26};
	...
	*rule27 = (struct rule) {.lhs = NT_MoreFields, .rhsLength = 2, .rhs = rhs27};
	...
	*rule28 = (struct rule) {.lhs = NT_MoreFields, .rhsLength = 1, .rhs = rhs28};
	RuleRightSideElement declarations = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*declarations = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_Declarations}};
	...
	*rule29 = (struct rule) {.lhs = NT_Declarations, .rhsLength = 2, .rhs = rhs29};
	...
	*rule30 = (struct rule) {.lhs = NT_Declarations, .rhsLength = 1, .rhs = rhs30};
	RuleRightSideElement globalOrNot = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*globalOrNot = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_GlobalOrNot}};
	...
	*rule31 = (struct rule) {.lhs = NT_Declaration, .rhsLength = 6, .rhs = rhs31};
	RuleRightSideElement tk_global = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_global = (struct ruleRightSideElement) {false, true, {.terminal = TK_GLOBAL }};
	...
	*rule32 = (struct rule) {.lhs = NT_GlobalOrNot, .rhsLength = 2, .rhs = rhs32};
	...
	*rule33 = (struct rule) {.lhs = NT_GlobalOrNot, .rhsLength = 1, .rhs = rhs33};
	RuleRightSideElement stmt = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*stmt = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_Stmt}};
	...
	*rule34 = (struct rule) {.lhs = NT_OtherStmts, .rhsLength = 2, .rhs = rhs34};
	...
	*rule35 = (struct rule) {.lhs = NT_OtherStmts, .rhsLength = 1, .rhs = rhs35};
	RuleRightSideElement assignmentStmt = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*assignmentStmt = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_AssignmentStmt}};
	...
	*rule36 = (struct rule) {.lhs = NT_Stmt, .rhsLength = 1, .rhs = rhs36};
	RuleRightSideElement iterativeStmt = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*iterativeStmt = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_IterativeStmt}};
	...
	*rule37 = (struct rule) {.lhs = NT_Stmt, .rhsLength = 1, .rhs = rhs37};
	RuleRightSideElement conditionalStmt = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*conditionalStmt = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_ConditionalStmt}};
	...
	*rule38 = (struct rule) {.lhs = NT_Stmt, .rhsLength = 1, .rhs = rhs38};
	RuleRightSideElement ioStmt = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*ioStmt = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_IoStmt}};
	...
	*rule39 = (struct rule) {.lhs = NT_Stmt, .rhsLength = 1, .rhs = rhs39};
	RuleRightSideElement funCallStmt = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*funCallStmt = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_FunCallStmt}};
	...
	*rule40 = (struct rule) {.lhs = NT_Stmt, .rhsLength = 1, .rhs = rhs40};
	RuleRightSideElement singleOrRecId = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*singleOrRecId = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_SingleOrRecId}};
	RuleRightSideElement tk_assignop = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_assignop = (struct ruleRightSideElement) {false, true, {.terminal = TK_ASSIGNOP }};
	RuleRightSideElement arithmeticExpression = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*arithmeticExpression = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_ArithmeticExpression}};
	...
	*rule41 = (struct rule) {.lhs = NT_AssignmentStmt, .rhsLength = 4, .rhs = rhs41};
	RuleRightSideElement optionSingleConstructed = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*optionSingleConstructed = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_OptionSingleConstructed}};
	...
	*rule42 = (struct rule) {.lhs = NT_SingleOrRecId, .rhsLength = 2, .rhs = rhs42};
	...
	*rule43 = (struct rule) {.lhs = NT_OptionSingleConstructed, .rhsLength = 1, .rhs = rhs43};
	RuleRightSideElement oneExpansion = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*oneExpansion = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_OneExpansion}};
	RuleRightSideElement moreExpansions = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*moreExpansions = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_MoreExpansions}};
	...
	*rule44 = (struct rule) {.lhs = NT_OptionSingleConstructed, .rhsLength = 2, .rhs = rhs44};
	RuleRightSideElement tk_dot = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_dot = (struct ruleRightSideElement) {false, true, {.terminal = TK_DOT }};
	...
	*rule45 = (struct rule) {.lhs = NT_OneExpansion, .rhsLength = 2, .rhs = rhs45};
	...
	*rule46 = (struct rule) {.lhs = NT_MoreExpansions, .rhsLength = 2, .rhs = rhs46};
	...
	*rule48 = (struct rule) {.lhs = NT_FunCallStmt, .rhsLength = 7, .rhs = rhs48};
	RuleRightSideElement idList = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*idList = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_IdList}};
	...
	*rule49 = (struct rule) {.lhs = NT_OutputParameters, .rhsLength = 4, .rhs = rhs49};
	...
	*rule50 = (struct rule) {.lhs = NT_OutputParameters, .rhsLength = 1, .rhs = rhs50};
	...
	*rule53 = (struct rule) {.lhs = NT_ConditionalStmt, .rhsLength = 9, .rhs = rhs53};
	RuleRightSideElement tk_else = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_else = (struct ruleRightSideElement) {false, true, {.terminal = TK_ELSE }};
	...
	*rule54 = (struct rule) {.lhs = NT_ElsePart, .rhsLength = 3, .rhs = rhs54};
	...
	*rule55 = (struct rule) {.lhs = NT_ElsePart, .rhsLength = 1, .rhs = rhs55};
	RuleRightSideElement tk_read = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_read = (struct ruleRightSideElement) {false, true, {.terminal = TK_READ }};
	RuleRightSideElement var = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*var = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_Var}};
	...
	*rule56 = (struct rule) {.lhs = NT_IoStmt, .rhsLength = 5, .rhs = rhs56};
	RuleRightSideElement tk_write = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_write = (struct ruleRightSideElement) {false, true, {.terminal = TK_WRITE }};
	...
	*rule57 = (struct rule) {.lhs = NT_IoStmt, .rhsLength = 5, .rhs = rhs57};
	RuleRightSideElement term = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*term = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_Term}};
	RuleRightSideElement moreTerms = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*moreTerms = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_MoreTerms}};
	...
	*rule58 = (struct rule) {.lhs = NT_ArithmeticExpression, .rhsLength = 2, .rhs = rhs58};
	...
	*rule59 = (struct rule) {.lhs = NT_ArithmeticExpression, .rhsLength = 3, .rhs = rhs59};
	...
	*rule60 = (struct rule) {.lhs = NT_ArithmeticExpression, .rhsLength = 1, .rhs = rhs60};
	RuleRightSideElement lowPrecedenceOperator = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*lowPrecedenceOperator = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_LowPrecedenceOperator}};
	...
	*rule61 = (struct rule) {.lhs = NT_MoreTerms, .rhsLength = 3, .rhs = rhs61};
	...
	*rule62 = (struct rule) {.lhs = NT_MoreTerms, .rhsLength = 1, .rhs = rhs62};
	RuleRightSideElement factor = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*factor = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_Factor}};
	RuleRightSideElement moreFactors = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*moreFactors = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_MoreFactors}};
	...
	*rule63 = (struct rule) {.lhs = NT_Term, .rhsLength = 2, .rhs = rhs63};
	RuleRightSideElement highPrecedenceOperator = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*highPrecedenceOperator = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_HighPrecedenceOperator}};
	...
	*rule64 = (struct rule) {.lhs = NT_MoreFactors, .rhsLength = 3, .rhs = rhs64};
	...
	*rule65 = (struct rule) {.lhs = NT_MoreFactors, .rhsLength = 1, .rhs = rhs65};
	...
	*rule66 = (struct rule) {.lhs = NT_Factor, .rhsLength = 3, .rhs = rhs66};
	...
	*rule67 = (struct rule) {.lhs = NT_Factor, .rhsLength = 1, .rhs = rhs67};
	RuleRightSideElement tk_mul = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_mul = (struct ruleRightSideElement) {false, true, {.terminal = TK_MUL }};
	...
	*rule68 = (struct rule) {.lhs = NT_HighPrecedenceOperator, .rhsLength = 1, .rhs = rhs68};
	RuleRightSideElement tk_div = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_div = (struct ruleRightSideElement) {false, true, {.terminal = TK_DIV }};
	...
	*rule69 = (struct rule) {.lhs = NT_HighPrecedenceOperator, .rhsLength = 1, .rhs = rhs69};
	RuleRightSideElement tk_plus = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_plus = (struct ruleRightSideElement) {false, true, {.terminal = TK_PLUS }};
	...
	*rule70 = (struct rule) {.lhs = NT_LowPrecedenceOperator, .rhsLength = 1, .rhs = rhs70};
	RuleRightSideElement tk_minus = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_minus = (struct ruleRightSideElement) {false, true, {.terminal = TK_MINUS }};
	...
	*rule71 = (struct rule) {.lhs = NT_LowPrecedenceOperator, .rhsLength = 1, .rhs = rhs71};
	RuleRightSideElement logicalOp = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*logicalOp = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_LogicalOp}};
	...
	*rule72 = (struct rule) {.lhs = NT_BooleanExpression, .rhsLength = 7, .rhs = rhs72};
	RuleRightSideElement relationalOp = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*relationalOp = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_RelationalOp}};
	...
	*rule73 = (struct rule) {.lhs = NT_BooleanExpression, .rhsLength = 3, .rhs = rhs73};
	RuleRightSideElement tk_not = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_not = (struct ruleRightSideElement) {false, true, {.terminal = TK_NOT }};
	...
	*rule74 = (struct rule) {.lhs = NT_BooleanExpression, .rhsLength = 4, .rhs = rhs74};
	RuleRightSideElement tk_num = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_num = (struct ruleRightSideElement) {false, true, {.terminal = TK_NUM }};
	...
	*rule75 = (struct rule) {.lhs = NT_Var, .rhsLength = 1, .rhs = rhs75};
	RuleRightSideElement tk_rnum = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_rnum = (struct ruleRightSideElement) {false, true, {.terminal = TK_RNUM }};
	...
	*rule76 = (struct rule) {.lhs = NT_Var, .rhsLength = 1, .rhs = rhs76};
	...
	*rule77 = (struct rule) {.lhs = NT_Var, .rhsLength = 1, .rhs = rhs77};
	RuleRightSideElement tk_and = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_and = (struct ruleRightSideElement) {false, true, {.terminal = TK_AND }};
	...
	*rule78 = (struct rule) {.lhs = NT_LogicalOp, .rhsLength = 1, .rhs = rhs78};
	RuleRightSideElement tk_or = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_or = (struct ruleRightSideElement) {false, true, {.terminal = TK_OR }};
	...
	*rule79 = (struct rule) {.lhs = NT_LogicalOp, .rhsLength = 1, .rhs = rhs79};
	RuleRightSideElement tk_lt = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_lt = (struct ruleRightSideElement) {false, true, {.terminal = TK_LT }};
	...
	*rule80 = (struct rule) {.lhs = NT_RelationalOp, .rhsLength = 1, .rhs = rhs80};
	RuleRightSideElement tk_le = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_le = (struct ruleRightSideElement) {false, true, {.terminal = TK_LE }};
	...
	*rule81 = (struct rule) {.lhs = NT_RelationalOp, .rhsLength = 1, .rhs = rhs81};
	RuleRightSideElement tk_eq = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_eq = (struct ruleRightSideElement) {false, true, {.terminal = TK_EQ }};
	...
	*rule82 = (struct rule) {.lhs = NT_RelationalOp, .rhsLength = 1, .rhs = rhs82};
	RuleRightSideElement tk_gt = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_gt = (struct ruleRightSideElement) {false, true, {.terminal = TK_GT }};
	...
	*rule83 = (struct rule) {.lhs = NT_RelationalOp, .rhsLength = 1, .rhs = rhs83};
	RuleRightSideElement tk_ge = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_ge = (struct ruleRightSideElement) {false, true, {.terminal = TK_GE }};
	...
	*rule84 = (struct rule) {.lhs = NT_RelationalOp, .rhsLength = 1, .rhs = rhs84};
	RuleRightSideElement tk_ne = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_ne = (struct ruleRightSideElement) {false, true, {.terminal = TK_NE }};
	...
	*rule85 = (struct rule) {.lhs = NT_RelationalOp, .rhsLength = 1, .rhs = rhs85};
	RuleRightSideElement tk_return = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*tk_return = (struct ruleRightSideElement) {false, true, {.terminal = TK_RETURN }};
	RuleRightSideElement optionalReturn = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*optionalReturn = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_OptionalReturn}};
	...
	*rule86 = (struct rule) {.lhs = NT_ReturnStmt, .rhsLength = 3, .rhs = rhs86};
	...
	*rule87 = (struct rule) {.lhs = NT_OptionalReturn, .rhsLength = 3, .rhs = rhs87};
	...
	*rule88 = (struct rule) {.lhs = NT_OptionalReturn, .rhsLength = 1, .rhs = rhs88};
	RuleRightSideElement moreIds = (RuleRightSideElement) malloc(sizeof(struct ruleRightSideElement));
	*moreIds = (struct ruleRightSideElement) {false, false, {.nonTerminal = NT_MoreIds}};
	...
	*rule89 = (struct rule) {.lhs = NT_IdList, .rhsLength = 2, .rhs = rhs89};
	...
	*rule90 = (struct rule) {.lhs = NT_MoreIds, .rhsLength = 2, .rhs = rhs90};
	...
	*rule92 = (struct rule) {.lhs = NT_DefinetypeStmt, .rhsLength = 5, .rhs = rhs92};
	...
	*rule93 = (struct rule) {.lhs = NT_A, .rhsLength = 1, .rhs = rhs93};
	...
	*rule94 = (struct rule) {.lhs = NT_A, .rhsLength = 1, .rhs = rhs94};
